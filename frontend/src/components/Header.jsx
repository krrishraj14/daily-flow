      ...
      <div className="relative flex items-center hidden sm:flex">
        <input
          ...
          className={`w-10 h-10 rounded-full border-none outline-none px-4 py-2 transition-all duration-500 ease-in-out ${
            darkMode
              ? 'bg-slate-800 text-gray-100 placeholder-transparent focus:placeholder-gray-600 focus:w-72 focus:bg-slate-700 focus:border-blue-600 focus:border'
              : 'bg-transparent text-gray-800 placeholder-transparent focus:placeholder-gray-400 focus:w-72 focus:bg-blue-50 focus:border-blue-500 focus:border'
          }`}
        />
        <svg
          ...
          className={`absolute left-3 w-5 h-5 transition-all duration-500 pointer-events-none ${
            darkMode ? 'fill-blue-500' : 'fill-blue-600'
          }`}
        >
